...
%::safe = (
    ...
    'reports/report.html.tmpl' =>
        [ 'width', 'height', 'imageurl', 'formaturl', 'other_format.name', 'switchbase', 'cumulate', ],
    ...
    'global/header.html.tmpl' => [
        'javascript',                   'style',     'onload',           'title',
        '" &ndash; $header" IF header', 'subheader', 'header_addl_info', 'message',
    ],
    ...
    'attachment/edit.html.tmpl' => [ 'attachment.id', 'attachment.bug_id', 'editable_or_hide', 'use_patchviewer', ],
    ...
    'attachment/diff-file.html.tmpl' => [
        'file.minus_lines', 'file.plus_lines', 'section.old_start', 'section_num',
