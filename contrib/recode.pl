...
my %switch;
GetOptions( \%switch, 'dry-run', 'guess', 'charset=s', 'show-failures', 'overrides=s', 'help|h' );
...
if ( $dbh->isa('Bugzilla::DB::Mysql') ) {
    ...
    my $collation_data = $dbh->selectrow_arrayref("SHOW VARIABLES LIKE 'character_set_database'");
